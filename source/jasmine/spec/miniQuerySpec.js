...
describe("DOM", function(){
  ...
  describe(".hide", function(){
    ...
    it("hides elements", function(){
      DOM.hide('#eyed')
      expect(SweetSelector.select('#eyed')[0].style.display).toBe('none')
    })
  })
  describe(".show", function(){
    ...
    it("shows an element", function(){
      DOM.show('#eyed')
      expect(SweetSelector.select('#eyed')[0].style.display).toBe('block')
    })
  })
  describe(".addClass", function(){
    ...
    it("adds a class to an element", function(){
      ...
      expect(SweetSelector.select("#eyed")[0].classList[0]).toContain("new-class")
    })
  })
  describe(".removeClass", function(){
    ...
    it("removes a class from an element", function(){
      ...
      var result = SweetSelector.select("#eyed")[0].classList.contains("new-class")
